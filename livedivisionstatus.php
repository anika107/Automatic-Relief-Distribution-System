<?php
    ...
    class status{
        ...
        function status(){
            ...
            $get_user = "select division as name , sum(case when admission_status = 'admitted' and critical_status = 'yes' then 1 else 0 end )
             as active from patient_info GROUP by division";
