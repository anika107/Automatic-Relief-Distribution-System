						...
						<tbody>
							<?php
                               ...
                               foreach ($pdo->query($sql) as $row) {
										...
										echo '<td> <a class="primary-btn btn-normal appoinment-btn" href="user data edit page.php?id='.$row['id'].'"  style = border: 1px solid #002933;>Details</a>';
                                        echo ' ';
                                        echo '<td> <a class="primary-btn btn-normal appoinment-btn" href="user data edit page.php?id='.$row['id'].'">Edit</a>';
                                        echo ' ';
										echo "</tr>";
									}
                                Database::disconnect();
