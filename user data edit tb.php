			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="nid" type="text"  placeholder="" value="<?php echo $data['nid'];?>" readonly>
						</div>
					</div>
					...
					<div class="control-group">
						<label class="control-label">No of Member</label>
						<div class="controls">
							<input name="member" type="text" placeholder="" value="<?php echo $data['member'];?>" required>
						</div>
					</div>
